...
public class IdTypeUtil {
    ...
    public static IdCard idCards(String country, boolean isDocV) {
        switch (country) {
            ...
            case Country.GHANA:
                IdCard.For idCardFor =
                        new IdCard.For(Country.GHANA).setCountryCode("233");
                idCardFor.addCard(IdType.DRIVER_LICENSE)
                        .addCard(IdType.PASSPORT)
                        .addCard(IdType.SSNIT)
                        .addCard(IdType.VOTER_ID);
                if (isDocV) {
                    idCardFor.addCard(IdType.NATIONAL_ID_NON_CITIZEN)
                            .addCard(IdType.NATIONAL_ID)
                            .addCard(IdType.GHANA_CARD)
                    ;
                } else {
                    idCardFor.addCard(IdType.NEW_VOTER_ID);
                }
                return idCardFor.create();
            ...
            case Country.KENYA:
                IdCard.For kenyaIDs =
                        new IdCard.For(Country.KENYA).setCountryCode("254");

                kenyaIDs.addCard(IdType.NATIONAL_ID)
                        .addCard(IdType.PASSPORT);
                if (!isDocV) {
                    kenyaIDs.addCard(IdType.ALIEN_CARD);
                }
                return kenyaIDs.create();
            ...
            case Country.NIGERIA:
                IdCard.For ngIds =
                        new IdCard.For(Country.NIGERIA).setCountryCode("234");
                ngIds.addCard(IdType.DRIVER_LICENSE)
                        .addCard(IdType.VOTER_ID);
                if (!isDocV) {
                    ngIds.addCard(IdType.BANK_ACCOUNT)
                            .addCard(IdType.BVN)
                            .addCard(IdType.NIN)
                            .addCard(IdType.NIN_V2)
                            .addCard(IdType.NIN_SLIP)
                            .addCard(IdType.PHONE_NUMBER);
                } else {
                    ngIds.addCard(IdType.PASSPORT)
                            .addCard(IdType.NATIONAL_ID);
                }
                return ngIds.create();
            ...
            case Country.SOUTH_AFRICA:
                IdCard.For saIds = new IdCard.For(Country.SOUTH_AFRICA)
                        .setCountryCode("27")
                        .addCard(IdType.NATIONAL_ID);
                if (isDocV) {
                    saIds.addCard(IdType.DRIVER_LICENSE)
                            .addCard(IdType.GREEN_BOOK)
                            .addCard(IdType.NATIONAL_ID)
                            .addCard(IdType.PASSPORT)
                            .addCard(IdType.RESIDENT_CARD);
                } else {
                    saIds.addCard(IdType.NATIONAL_ID)
                            .addCard(IdType.NATIONAL_ID_NO_PHOTO);
                }
            ...
            case Country.TANZANIA:
                return new IdCard.For(Country.TANZANIA)
                        ...
                        .addCard(IdType.DRIVER_LICENSE)
                        .addCard(IdType.PASSPORT)
                        .addCard(IdType.CITIZEN_ID)
                        .addCard(IdType.VOTER_ID)
                        .addCard(IdType.STUDENT_ID)
                        .addCard(IdType.NATIONAL_ID)
                        .create();

            case Country.UGANDA:
                IdCard.For ugandaIds = new IdCard.For(Country.UGANDA)
                        .setCountryCode("256");
                if (isDocV) {
                    ugandaIds.addCard(IdType.DRIVER_LICENSE)
                            .addCard(IdType.NATIONAL_ID)
                            .addCard(IdType.PASSPORT)
                    ;
                } else {
                    ugandaIds.addCard(IdType.NATIONAL_ID_NO_PHOTO);
                }
                return ugandaIds.create();
